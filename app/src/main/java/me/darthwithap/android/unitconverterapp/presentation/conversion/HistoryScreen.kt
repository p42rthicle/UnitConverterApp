...
fun HistoryScreen(
  ...
  Box(
    ...
    if (state.recentConversions.isNotEmpty() || state.recentConversionUnits.isNotEmpty()) {
      LazyColumn {
      ...
      Column(
        ...
        Text(
            modifier = Modifier.padding(vertical = 8.dp),
            text = stringResource(id = R.string.no_recent_conversions),
            style = MaterialTheme.typography.headlineSmall.copy(
                fontWeight = FontWeight.SemiBold,
                color = MaterialTheme.colorScheme.onSurface
            ),
        ...
        Text(
            modifier = Modifier.padding(vertical = 8.dp),
            text = stringResource(id = R.string.no_recent_conversions_desc),
